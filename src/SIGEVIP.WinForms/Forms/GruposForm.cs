...
{
    public sealed class GruposForm : Form
    {
            ...
            bool activar)
        {
            ...
            {
                MessageBox.Show(
                    "El grupo seleccionado ya se encuentra activo.",
                    "Grupos",
            ...
            {
                MessageBox.Show(
                    "El grupo seleccionado ya se encuentra inactivo.",
                    "Grupos",
                    MessageBoxButtons.OK,
                    MessageBoxIcon.Information);
            ...
            DialogResult confirmacion =
                MessageBox.Show(
                    activar
                        ? "¿Desea activar el grupo seleccionado?"
                        : "¿Desea desactivar el grupo seleccionado? " +
                          "Sus asignaciones se conservarán, pero dejará " +
                          "de otorgar permisos hasta ser reactivado.",
                    "Confirmar",
            ...
            try
            {
                if (activar)
                {
                    _grupoService.Activar(
                        seleccionado.IdGrupo);
                }
                else
                {
                    _grupoService.Desactivar(
                        seleccionado.IdGrupo);
                }
        ...
        private void CargarGrupos()
        {
            ...
            try
            {
                ...
                IReadOnlyCollection<GrupoListadoDto>
                    grupos =
                        _grupoService.Listar(
                            filtro);

                List<GrupoListadoDto> lista =
                    grupos.ToList();
        ...
        private GrupoListadoDto ObtenerSeleccionado()
        {
            ...
            Exception exception)
        {
            ...
            {
                MessageBox.Show(
                    "No fue posible acceder a los grupos. " +
            ...
            MessageBox.Show(
                "Ocurrió un error inesperado en el módulo de grupos.",
                "Error",
                MessageBoxButtons.OK,
                MessageBoxIcon.Error);
        }
