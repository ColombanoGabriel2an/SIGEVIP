...
\- ocultamiento del módulo sin `USUARIO\_GESTIONAR`.
...
\- no puede retirarse `ADMINISTRADOR\_GENERAL` al último Administrador activo;
...
\- visibilidad mediante `USUARIO\_GESTIONAR`;
